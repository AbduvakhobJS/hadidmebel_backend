...
const createProduct = async (req, res) => {
    ...
    const { catalog_Id, catalog_name, description, title, pagonametr, fasad, material, staleshnitsa, bonus} = req.body
    const product = new ProductModel({
        catalog_Id, catalog_name, description, title, pagonametr, fasad, material, staleshnitsa, bonus,
        image: arrayFiles
    })
    product.save()
...
const UpdateProduct = async (req, res) => {
    ...
    updateFile.pagonametr = pagonametr
    updateFile.material = material
    updateFile.description = description
    updateFile.fasad = fasad
    updateFile.staleshnitsa = staleshnitsa
